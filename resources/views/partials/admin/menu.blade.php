    ...
    <div class="scrollbar-inner">
        <div class="div-mega">
            <ul class="navbar-nav navbar-nav-docs">
                ...
                {{-- @can('manage contract') --}}
                <li class="nav-item">
                    <a href="{{route('contract.index')}}" class="nav-link {{ (Request::route()->getName() == 'contract.index' || Request::route()->getName() == 'contract.show') ? ' active' : '' }}">
                        <i class="fas fa-file"></i>{{__('Contract')}}
                    </a>
                </li>
                {{-- @endcan --}}
                {{-- @can('manage contract') --}}
                <li class="nav-item">
                    <a href="{{route('invoice.index')}}" class="nav-link {{ (Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.show') ? ' active' : '' }}">
                 ...
                 @if(Gate::check('manage bill'))
                    <li class="nav-item">
                        <a href="{{ route('bill.index') }}" class="nav-link {{ (Request::segment(1) == 'bill')?'active':''}}">
                            <i class="fas fa-sticky-note"></i>{{__('Bill')}}
                        </a>
                    </li>
                @endif
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse {{ (Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note')?'show':''}}" id="navbar-income">
                            <ul class="nav flex-column submenu-ul">
                                ...
                                @endcan
                                    <li class="nav-item {{ (Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show') ? ' active' : '' }}">
                                        <a href="{{ route('invoice.index') }}" class="nav-link">{{ __('Contract') }}</a>
                                    </li>
                                @can('manage revenue')
