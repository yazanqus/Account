...
<?php $__env->startSection('content'); ?>
    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                <div class="input-group">
                                    ...
                                    <?php echo e(Form::select('customer_id', $customers,null, array('class' => 'form-control select2 ','id'=>'customer','data-url'=>route('proposal.customer'),'required'=>'required'))); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <?php echo e(Form::select('item', $product_services,null, array('class' => 'form-control select2 item','data-url'=>route('proposal.product')))); ?>
        ...
        <div class="col-12 text-right">
            ...
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("proposal.index")); ?>';" class="btn-create btn-xs bg-gray radius-10px">
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Account\resources\views/proposal/edit.blade.php ENDPATH**/ ?>