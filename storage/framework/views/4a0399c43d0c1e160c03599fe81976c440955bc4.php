<div class="card bg-none card-box">
    <?php echo e(Form::model($revenue, array('route' => array('revenue.update', $revenue->id), 'method' => 'PUT'))); ?>
    ...
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            <div class="input-group">
                ...
                <?php echo e(Form::select('customer_id', $customers,null, array('class' => 'form-control select2','required'=>'required'))); ?>
...
<?php /**PATH C:\laragon\www\Account\resources\views/revenue/edit.blade.php ENDPATH**/ ?>